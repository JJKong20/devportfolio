...
EDITOR NOTES: Must use nvm ver 13 or below (used 10.22.0), must use Gulp 3 (used 3.8.11 for Local (npm i gulp@3.8.11) and CLI (npm install -g gulp@3.8.11), global is required for the project).
